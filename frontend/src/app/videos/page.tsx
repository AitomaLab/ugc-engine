                                ...
                                <div className='video-info' style={{ display: 'flex', gap: '8px', paddingTop: 0, paddingBottom: '12px', marginTop: 'auto' }}>
                                    {job.final_video_url ? (
                                        <>
                                            ...
                                            <button style={{ flex: 1, padding: '6px 0', backgroundColor: 'transparent', color: '#0b84f3', borderRadius: '4px', fontSize: '12px', fontWeight: 600, display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '6px', border: '1px solid rgba(11,132,243,0.25)', cursor: 'pointer' }} onClick={() => window.open(`/editor/${job.id}`, '_blank')}>
                                                <svg viewBox="0 0 24 24" style={{ width: '14px', height: '14px', fill: 'none', stroke: 'currentColor', strokeWidth: 2 }}><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7" /><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>
                                                {t('videos.edit') || 'Edit'}
                                            </button>
