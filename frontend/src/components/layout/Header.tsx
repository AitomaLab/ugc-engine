...
const IconBox = () => (
    <svg viewBox="0 0 24 24">
        ...
        <path d="M12 12 L12 4 M12 12 L3 16 M12 12 L19 16" />
    </svg>
);
...
const IconCarousel = () => (
    <svg viewBox="0 0 24 24" className="nav-icon-carousel">
        {/* back card — top + right edges (offset up-right) */}
        <path d="M7 4.5 H19.5 V16.5" />
        {/* front card */}
        <rect x="4.5" y="7" width="13" height="13" rx="2" />
    </svg>
);
...
> = [
    ...
    { href: '/brands', labelKey: 'nav.brands', label: 'Brands', Icon: IconCarousel },
